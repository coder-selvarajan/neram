...
//        }
    ...
    //basic logic
    //splitting the array when it exceeds screen size
    func getRows()->[[Tag]]{
        var rows: [[Tag]] = []
        var currentRow: [Tag] = []
        ...
        tags.forEach { tag in
            ...
            //checking is totalwidth is greater than size..
...
struct TagView_Previews: PreviewProvider {
    @State static var testTags : [Tag] = []
    static var previews: some View {
        TagView(maxLimit: 100, tags: $testTags)
            .frame(height: 280)
    }
}
